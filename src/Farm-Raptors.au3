...
Func GetRaptors()
	...
	IsBossAggroed()
	If MoveAggroingRaptors(-20000, -10300) == $FAIL Or _
		MoveAggroingRaptors(-19500, -11500) == $FAIL Or _
		MoveAggroingRaptors(-20500, -12000) == $FAIL Or _
		MoveAggroingRaptors(-21000, -12200) == $FAIL Or _
		MoveAggroingRaptors(-21500, -12000) == $FAIL Or _
		MoveAggroingRaptors(-22000, -12000) == $FAIL Then Return $FAIL
