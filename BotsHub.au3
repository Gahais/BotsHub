...
Func UpdateFarmDescription($Farm)
	...
	Switch $Farm
		...
		Case 'Gemstone Stygian'
			GUICtrlSetData($GUI_Edit_CharacterBuild, $StygianAssasinSkillBar & '		' & $StygianMesmerSkillBar & _
				 						@CRLF & $StygianRangerSkillBar)
			GUICtrlSetData($GUI_Edit_HeroBuild, $StygianMonkHeroSkillBar)
